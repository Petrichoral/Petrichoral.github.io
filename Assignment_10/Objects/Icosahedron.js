...
const Icosahedron = function(name, transform, update) {
  ...
  const ambientCoeff = 0.5;
  const diffuseCoeff = 0.5;
  const specularCoeff = 1.0;
  const specularExp = 1024.0;
  ...
  newIcosahedron.textureSource = textureSource;
  newIcosahedron.vertices = vertices;
  newIcosahedron.normals = normals;
  newIcosahedron.texCoords = texCoords;
  newIcosahedron.indices = indices;
  newIcosahedron.vertexCount = vertexCount;
  newIcosahedron.coeff = [ambientCoeff, diffuseCoeff, specularCoeff, specularExp];
